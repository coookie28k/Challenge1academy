func milenio(){
    ...
    printSlow("Mulher: Com licença jovem, teria algo de comer? Não como há uns dois dias.")
    ...
    if escolha1 == "a" || escolha1 == "A" {
        ...
        printSlow("Mulher: No último ano-novo, encontrei este estranho aparelho em uma lixeira. Use-o com sabedoria jovem. E obrigado pelos biscoitos! Estavam deliciosos!")
        printSlow("Você olha o aparelho com atenção e se espanta, é um iPhone! Antigo, mas um iPhone! Mas como poderia existir um iPhone em 1999? Em choque, você olha de volta para o mulher, contudo, esta já havia voltado para debaixo dos jornais.")
        iPhone = 1
    ...
    printSlow("Em seguida, você caminha pelas ruas barulhentas e caóticas, enquanto divaga o que fazer. Restam poucas horas para a virada do milênio, o tempo está se esgotando. Completamente sem rumo, você decide ir para um bar, beber. Avistando o mais próximo, você observa uma multidão no que parece ser um estabelecimento frequentado por senhores de idade.")
    printSlow(" “Vou perder toda a minha pesquisa por causa do bug do milênio, tantos anos gastos para nada” - você escuta um senhor calvo lamentando, enquanto põe para dentro um gole do que parece ser uma bebida forte com um cheiro doce. Você decide se aproximar e escutá-lo.")
    printSlow("Senhor: Olá meu jovem, o que lhe traz aqui? Qual sua lamentação?")
    ...
    if escolha2 == "a" || escolha2 == "A"{
        ...
        if iPhone == 0 {
            ...
            if D <= 10 {
                ...
                printSlow("Você fala com tanta convicção que inspira os trabalhadores a lutar por si mesmos. O bar fica completamente silencioso, e os olhares de todos ganham um novo brilho, com esperança e determinação. “Tem razão! Se ficarmos parados, será a nossa ruína! Vamos consertar essa bagunça!” - exclama um trabalhador. A multidão do bar explode em gritos de apoios, e o grupo de bêbados derrotados se transforma por completo, preparados para luta. Eles decidem te levar até a sua empresa, e o ajudam a entrar de fininho na sala do CEO.")
            } else {
                printSlow("Sua empolgação incentivou os trabalhadores a terem esperança e isso aqueceu seu coração. Eles decidem te levar até a sua empresa, e o ajudam a entrar de fininho na sala do CEO.")
            }
